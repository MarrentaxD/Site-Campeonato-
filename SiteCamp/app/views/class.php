...
<head>
    <title>Página de Classificação</title>
...
<div class="uk-container">
    <body bgcolor="#33B86">
    <div class="uk-grid">
        <a href="home"><img src="public/imagens/Oficial.png" width="100" height="100"/></a>
...
<br><br><br><br>
        ...
        <thead>
            ...
            <tr bgcolor="#0080FF">
                ...
                <th><font color="#fff">Pontos</font></th>
                <th><font color="#fff">Vitórias</font></th>
                <th><font color="#fff">Derrotas</font></th> 
                <th><font color="#fff">Gols</font></th> 
                <th><font color="#fff">Jogos</font></th>           
            </tr>
        </thead>
        ...
        <tbody>
            <tr bgcolor="#0080FF">
                ...
                <td><a href="home"><font color="#fff">Inter de Emirão</font></a></td>
                <td><font color="#fff">9</font></td>
                <td><font color="#fff">3</font></td>
                <td><font color="#fff">0</font></td>
